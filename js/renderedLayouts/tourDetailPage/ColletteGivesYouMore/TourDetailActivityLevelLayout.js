...
define([
		...
		'backbone',
		'marionette',
		'views/tourDetailPage/ColletteGivesYouMore/TourDetailActivityLevelView',
	...
	function (App, $, _, Backbone, Marionette, TourDetailActivityLevelView, RenderedLayout, EventAggregator) {
	    var TourDetailActivityLevelLayout = RenderedLayout.extend({
	        el: '#activityLevelSection',
	        regions: {
	            defaultView: "#activityLevelRegion"
	        },
	        initialize: function () {
	    ...
	    return TourDetailActivityLevelLayout;
	});