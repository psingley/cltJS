define([
    ...
    /**
     * Validation class for agents.
     *
     * @class agentStepValidation
     * @extends baseStepValidation
     */
    var agentStepValidation = (function () {
        var constructor = function () {
            ...
            /**
             * Returns an object with each section that contains
             * logic for validation for each particular section.
             *
             * @property sections
             * @type {{travelerInfo: {id: string, validateStep: validateStep, messages: Array, travelerViews: Array}, roomingAndTravelers: {id: string, validateStep: validateStep, messages: Array}, tourDate: {id: string, validateStep: validateStep, messages: Array}, tourCustomizations: {id: string, validateStep: validateStep, messages: Array}, flightsAndProtection: {id: string, validateStep: validateStep, messages: Array}, summaryAndPayment: {id: string, validateStep: validateStep}}}
             */
            this.sections = {
    ...
    agentStepValidation.prototype = new BaseStepValidation();
    return agentStepValidation;
});